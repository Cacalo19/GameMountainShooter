...
class EntityFactory:
    ...
    def get_entity(entity_name: str, position=(0, 0)):
        match entity_name:
            ...
            case 'Enemy1':
                return Enemy(name='Enemy1', position=(WIN_WIDTH + 10, random.randint(25, WIN_HEIGHT - 20)))
            case 'Enemy2':
                return Enemy(name='Enemy2', position=(WIN_WIDTH + 10, random.randint(25, WIN_HEIGHT - 20)))
